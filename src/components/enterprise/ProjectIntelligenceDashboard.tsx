...
import { ProjectIntelligenceReport, EvidenceDossierReport, CertificationApplication } from '../../types';
import { ExecutiveAiDashboardView } from './ExecutiveAiDashboardView';
...
export const ProjectIntelligenceDashboard: React.FC<ProjectIntelligenceDashboardProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'project_intelligence' | 'executive_ai'>('executive_ai');
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 p-1.5 bg-slate-200 dark:bg-slate-800 rounded-2xl">
        ...
        >
          ...
          <span>Executive AI Assessment Intelligence Dashboard</span>
        </button>

        <button
          onClick={() => setActiveTab('project_intelligence')}
          className={`flex-1 py-3 px-4 text-xs font-bold rounded-xl flex items-center justify-center gap-2 transition-all ${
        ...
        >
          ...
          <span>Project Intelligence Synthesis ({projectName})</span>
        </button>
      </div>

      {/* VIEW MODE 1: Executive AI Assessment Dashboard */}
      {activeTab === 'executive_ai' && (
      ...
      {/* VIEW MODE 2: Single Project Intelligence Synthesis */}
      {activeTab === 'project_intelligence' && (
        <div className="space-y-6">
